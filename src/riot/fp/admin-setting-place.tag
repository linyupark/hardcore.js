    ...
    <yield to="content">
      <form class="modal">
        <div class="row">
          <p>
            <label>职务名称</label>
            <input ref="place_name" type="text" value="{parent.place.place_name}">
          </p>
          <p>
            <label>排序</label>
            <input ref="place_sort" type="text" value="{parent.place.sort}">
            <input-valid style="left: 85px" ref="validPlace" for="place_name,place_sort" rule="required" msg="职务名称跟排序都为必填"/>
          </p>
        </div>
      </form>
    </yield>
